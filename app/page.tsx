...
export default function Page() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section id="contact" className="section-wrap contact-section"><div className="contact-card"><div><span className="section-kicker">04 / GET IN TOUCH</span><h2>Have a good idea?<br /><span>Let&apos;s make it real.</span></h2><p>I&apos;m open to internships, collaborations, and conversations about building useful software.</p><div className="contact-meta"><a href="mailto:oeurnleesinh52@gmail.com"><Mail size={15} /> oeurnleesinh52@gmail.com</a><span><Globe2 size={15} /> Phnom Penh · UTC+7</span></div></div><form onSubmit={e => { e.preventDefault(); setSent(true); setMessage('') }}><label>Name<input required placeholder="Your name" /></label><label>Email<input required type="email" placeholder="you@example.com" /></label><label>Message<textarea required value={message} onChange={e => setMessage(e.target.value)} placeholder="Tell me about the project..." /></label><button className="button-primary" type="submit">{sent ? 'Message ready to send' : 'Send a message'} {sent ? <Check size={16} /> : <ArrowUpRight size={16} />}</button></form></div></section>
      <footer><span className="brand"><span className="brand-mark">OL</span> OEURN LEE SINH</span><span>Designed & built with intention · 2026</span><div className="social-links"><a href="https://github.com/lee-sinh" target="_blank" rel="noreferrer" aria-label="GitHub"><GitBranch size={17} /></a><a href="https://www.linkedin.com/in/lee-sinh-oeurn-7a3b67291" target="_blank" rel="noreferrer" aria-label="LinkedIn"><BriefcaseBusiness size={17} /></a><a href="https://facebook.com/share/19w7fcrC7q/?mibextid=wwXIfr" target="_blank" rel="noreferrer" aria-label="Facebook"><Globe2 size={17} /></a><a href="https://t.me/leesinhh" target="_blank" rel="noreferrer" aria-label="Telegram"><Send size={17} /></a><a href="mailto:oeurnleesinh52@gmail.com" aria-label="Email"><Mail size={17} /></a></div></footer>
