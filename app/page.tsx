...
export default function Page() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <footer><span className="brand"><span className="brand-mark">OL</span> OEURN LEE SINH</span><span>Designed & built with intention · 2026</span><div><a href="https://github.com" aria-label="GitHub"><GitBranch size={17} /></a><a href="https://linkedin.com" aria-label="LinkedIn"><BriefcaseBusiness size={17} /></a><a href="mailto:oeurnleesinh52@gmail.com" aria-label="Email"><Mail size={17} /></a></div></footer>
